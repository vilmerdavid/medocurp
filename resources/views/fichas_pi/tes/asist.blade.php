<div class="table-responsive" id="table_asist_test">
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            ...
                            <option value="2">Si, en los últimos 3 meses</option>
                            <option value="1">Sí, pero no en los últimos 3 meses</option>
                        </select>
                    </td>
                    <td>
                        {{ $a->valor }}
            ...
            @if ($a->codigo=='p9_1')
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            <option value=""></option>
                            <option value="0">Una vez a la semana o menos, ó; menos de 3 días seguidos</option>
                            <option value="1">Más de una vez a la semana, ó; 3 o más días seguidos </option>
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            ...
                            <option value="3">Cada mes</option>
                            <option value="4">Cada semana</option>
                            <option value="6">A diario o casi a diario</option>
                        </select>
                    </td>
                    <td>
                        {{ $a->valor }}
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            <option value=""></option>
                            <option value="0">Nunca</option>
                            <option value="3">Una o dos veces</option>
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            <option value=""></option>
                            <option value="0">Nunca</option>
                            <option value="4">Una o dos veces</option>
                            <option value="5">Cada mes</option>
                            <option value="6">Cada semana</option>
                            <option value="7">A diario o casi a diario</option>
                        </select>
                    </td>
                    <td>
                        {{ $a->valor }}
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            <option value=""></option>
                            <option value="0">Nunca</option>
                            <option value="5">Una o dos veces</option>
                            <option value="6">Cada mes</option>
                            <option value="7">Cada semana</option>
                            <option value="8">A diario o casi a diario</option>
                        </select>
                    </td>
                    <td>
                        {{ $a->valor }}
                ...
                <tr>
                    ...
                    <td>
                        <select name="pregunta[{{ $a->id }}]" id="{{ $a->id }}" class="form-control">
                            <option value=""></option>
                            <option value="0">No, nunca</option>
                            <option value="6">Si, en los últimos 3 meses</option>
                            <option value="3">Sí, pero no en los últimos 3 meses</option>
                        </select>
                    </td>
                    <td>
                        {{ $a->valor }}
